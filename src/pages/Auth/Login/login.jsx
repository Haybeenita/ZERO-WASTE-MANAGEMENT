...
const Login = () => {
  ...
  const loginuser=()=>{
    logIn(formFilled.email, formFilled.password)
          ...
          <div className="md:w-[30rem] md:h-[40rem] w-[22rem] h-[32rem] pt-[2.5rem] mt-[2rem] shadow-2xl bg-white/35 rounded-lg bg-clip-padding backdrop-filter backdrop-blur-lg relative">
            ...
            <div className="flex flex-col md:w-[20rem] w-[18rem] md:ml-[5rem] ml-[2rem] md:mt-[2rem] mt-[1rem] justify-center ">
              ...
              <div className="flex justify-center md:mt-6 mt-4">
                <Button variant="primary" size="large" handleClick={loginuser}>
                  Sign in
                </Button>
              </div>
              <div className="flex gap-1 font-normal text-base text-black md:ml-6 ml-2 md:mt-2 mt-1">
                <span>Not a member?</span>
                <p className="text-[#0E5808] hover:text-blue-600 underline hover:underline-offset-4 cursor-pointer"><Link to="/Register"> Register Now</Link>
            ...
            <div className="flex gap-14 w-[15rem] items-center md:ml-[8rem] ml-[4.5rem] mt-[2rem]">
              <img src="/facebookicon.png" className="w-7 h-7 cursor-pointer" alt="" />
              <img src="/appleicon.png" className="w-7 h-7 cursor-pointer" alt="" />
              <img src="/googleicon.png" className="w-7 h-7 cursor-pointer" alt="" onClick={()=>GoogleLogin()} />
            </div>
          </div>
          <div className="absolute mr-[11rem] ">
          {registration && <p className="text-black text-lg font-semibold mb-[1rem] mt-[1rem] text-center">login successful</p>}
