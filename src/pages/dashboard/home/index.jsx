      ...
      <div className="flex lg:flex-row flex-col lg:items-center -mx-3 mt-2">
        <div className=" px-3 lg:flex-0 shrink-0">
          <div className="flex lg:flex-row flex-col flex-wrap lg:ml-[4rem] gap-10 ">
            ...
            <div className="card w-full max-w-[15rem] lg:h-[15rem] h-[12rem] px-4 sm:flex-0 shrink-0 sm:w-33% bg-white shadow-lg">
              <div className="flex flex-col">
                <h3 className="lg:text-2xl text-lg font-semibold leading-none text-[#212122] my-[1rem] ">
                  Support Contact
                </h3>
        ...
        <div className="flex lg:mt-0 mt-[1rem] lg:w-[30rem] w-[20rem] lg:p-3 p-2 lg:h-[15rem] h-[13rem] border-2 bg-gradient-to-r from-zero-400 via-zero-600 to-zero-800 rounded-xl flex-col ml-[0.5rem] lg:ml-[2rem]">
          ...
          <p className="text-white font-medium lg:text-base text-sm lg:mt-[1rem] mt-[0.2rem] text-center">
            ...
            booking for your waste pickup needs. Simply schedule, sit back, and
            let us handle the rest. Streamline your cleanup process today!
          </p>
