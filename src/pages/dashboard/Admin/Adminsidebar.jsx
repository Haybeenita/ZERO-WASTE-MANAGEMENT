...
import SidebarLink from "../../../components/dashboard/nav-link";
      ...
      >
        <div className="h-20 ">
          ...
          >
            <img
              src={logo}
              className="inline-block h-full max-w-full transition-all duration-200 ease-in-out max-h-8 dark:hidden w-7 h-7"
              alt="main_logo"
            />
            <img
              src={logo}
        ...
        >
          <ul className="flex flex-col pl-0 mb-0 list-none">
            <li className="mt-1 w-full">
              <SidebarLink to="/pending orders">
                <div
                  className={`${styles.icon} stroke-none shadow-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current p-2.5 text-center text-orange-500`}
                >
              ...
              <SidebarLink to="/pending orders">
                <div
                  className={`${styles.icon} stroke-none shadow-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current p-2.5 text-center text-blue-500`}
                >
                  <FaThList width="12px" height="12px" />
                </div>
              ...
              <SidebarLink to="/pending orders">
                <div
                  className={`${styles.icon} stroke-none shadow-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current p-2.5 text-center text-green-500`}
                >
                  <FaThList width="12px" height="12px" />
                </div>
